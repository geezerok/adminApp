 ...
 * @see com.geezer.adminapp.hibernate.Part
...
public class PartHome {
	...
	public Part merge(Part detachedInstance) {
		...
		try {
			Part result = (Part) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Part findById(java.lang.Integer id) {
		...
		try {
			Part instance = (Part) sessionFactory.getCurrentSession().get(
					"com.geezer.adminapp.hibernate.Part", id);
			if (instance == null) {
	...
	public List findByExample(Part instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.geezer.adminapp.hibernate.Part")
