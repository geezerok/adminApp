...
/**
 * Home object for domain model class Computer.
 * @see com.geezer.adminapp.hibernate.Computer
 * @author Hibernate Tools
 */
public class ComputerHome {

	private static final Log log = LogFactory.getLog(ComputerHome.class);
	...
	public void persist(Computer transientInstance) {
		log.debug("persisting Computer instance");
		try {
	...
	public Computer merge(Computer detachedInstance) {
		...
		try {
			Computer result = (Computer) sessionFactory.getCurrentSession()
	...
	public Computer findById(java.lang.Integer id) {
		...
		try {
			Computer instance = (Computer) sessionFactory.getCurrentSession()
					.get("com.geezer.adminapp.hibernate.Computer", id);
			if (instance == null) {
	...
	public List findByExample(Computer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.geezer.adminapp.hibernate.Computer")
